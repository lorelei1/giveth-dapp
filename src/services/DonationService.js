...
class DonationService {
   ...
   * @param {string}   amount      Total ammount to be delegated - needs to be between 0 and total donation amount
  ...
  static delegateMultiple(
    ...
    console.log(donations, amount, delegateTo, delegateTo instanceof Campaign);
    onCreated();
    onSuccess();
    onError();
